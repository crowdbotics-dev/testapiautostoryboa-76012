...
## Project Structure
    ...
    ├── testapiautostoryboa_76012  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_76012`
...
2. Clone this repo and `cd testapiautostoryboa_76012`
